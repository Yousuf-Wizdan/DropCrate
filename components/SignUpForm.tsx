...
const SignUpForm = () => {
    ...
    const [verficationCode, setVertificationCode] = useState('')
    ...
    const onSubmit = async (data: z.infer<typeof signUpSchema>) => {
        ...
        try {
            ...
            setAuthError(err.error?.[0].message || 'An Error Occured during Sign Up')
    ...
    const handleSubmitVerification = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (result.status === 'complete') {
                ...
                setVerificationError('Verification Could Not Complete')
            ...
            setVerificationError(err.errors)
